# Homebrew formula for a personal tap, such as ngoquocdat/homebrew-pitboard.
#
...
class Pitboard < Formula
  ...
  homepage "https://github.com/ngoquocdat/pitboard"
  url "https://github.com/ngoquocdat/pitboard/archive/refs/tags/v0.1.0.tar.gz"

...
so install one or the other. If you installed the app as `datlechin/tap/pitboard` before,
that name is the command line now: install the app again as `pitboard-app`. pitboard's

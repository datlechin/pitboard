...
/// Deletes every parked login, then pitboard's own directory. Claude Code's login is left
/// exactly as it is: whoever is signed in stays signed in.
///
...
/// refresh tokens on the machine with no way left to name them.
